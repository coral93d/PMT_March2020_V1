...
namespace WebTimeSheetManagement.Concrete
{
    public class AssignRolesConcrete : IAssignRoles
    {
        ...
        public List<QualityModel> ListofQuality()
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["TimesheetDBEntities"].ToString()))
            {
                ...
                try
                {
                    var result = con.Query<QualityModel>("Usp_GetListofQuality", null, null, true, 0, System.Data.CommandType.StoredProcedure).ToList();
                    return result;
                }
                catch (Exception)
                {
        ...
        public List<Registration> GetUserBasedOn_Admin(string Name)
        {
            using (var _context = new DatabaseContext())
            {
                ...
                var listofUser = (from a in _context.Registration
                                      ...
                                      // join b in _context.Registration on a.RM_Username equals b.RM_Username
                                  where a.RM_Username == Name
                                  select a).ToList();
        ...
        public List<UserModel> GetListofUnAssignedUsers(string RM_Username)
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["TimesheetDBEntities"].ToString()))
            {
                ...
                {
                    var param = new DynamicParameters();
                    param.Add("@RM_Username", RM_Username);
                    var result = con.Query<UserModel>("Usp_GetListofUnAssignedUsersRM", param, null, true, 0, System.Data.CommandType.StoredProcedure).ToList();
                    return result;
                }
                catch (Exception)
                {
