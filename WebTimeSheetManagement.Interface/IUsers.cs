...
namespace WebTimeSheetManagement.Interface
{
    public interface IUsers
    {
       ...
       // IQueryable<FormViewSummaryModel> ShowallForms(string sortColumn, string sortColumnDir, string Search);
      ...
      //  IQueryable<FormViewSummaryModel> ShowallFormData(string sortColumn, string sortColumnDir, string Search);
        ...
        bool RemoveUser(string RegistrationID);
    }
}
