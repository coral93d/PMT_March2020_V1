                ...
                if (!string.IsNullOrEmpty(loginViewModel.Username) && !string.IsNullOrEmpty(loginViewModel.Password))
                {
                    ...
                    if (result != null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Session["Quality"] = Convert.ToString(result.RegistrationID);
                                ...
                                return RedirectToAction("Dashboard", "Quality");
                            }
                            else if (RoleID == 5)
                            {
                                Session["QualityLead"] = Convert.ToString(result.RegistrationID);
                                ...
                                //Session["UserID"] = Convert.ToString(result.RegistrationID);
                                return RedirectToAction("Dashboard", "QualityLead");
                            }
